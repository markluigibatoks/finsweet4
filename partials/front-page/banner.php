<div class="main-box lg:pt-19 pt-10">
    <div class="wrapper">
        <div class="flex md:flex-row flex-col gap-5 justify-between items-center">
            ...
            <div class="order-1 md:order-2">
                ...
                <a href="mailto:james@finsweet.com" class="mt-1 block max-w-max hover:underline text-xl opacity-85">james@finsweet.com</a>
            </div>
        </div>
    </div>
</div>