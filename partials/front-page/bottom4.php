<div class="main-box">
    <div class="wrapper border-y border-y-white/17 py-20">
        <div class="w-full text-center lg:text-left">
            <span class="text-cap-1 opacity-87 uppercase">My Recent Work</span>
            <h2 class="lg:max-w-[446px] lg:mt-6 mt-2 lg:text-h2 md:text-h4 text-h5 opacity-85">I love taking Design from vision to reality.</h2>
        </div>
        ...
        <div class="lg:mt-20 mt-10 columns-2 gap-2 lg:gap-x-8">
          ...
          <div class="group max-w-max mx-auto mb-2 lg:mb-11 relative cursor-pointer">
            ...
            <img class="object-cover w-full h-full" src="<?php echo get_template_directory_uri();?>/assets/images/front-page/bottom4-img4.jpg" alt="portfolio"/>
          </div>
        </div>

        <a href="#" class="button-primary mx-auto lg:mt-16 mt-10 max-w-max block">View all projects</a>
    </div>
</div>