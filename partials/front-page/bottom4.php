<div class="main-box">
    <div class="wrapper border-t border-t-white/17 py-20">
        <div class="w-full text-center lg:text-left">
            <span class="text-cap-1 opacity-87 uppercase">My Recent Work</span>
            <h2 class="lg:mt-6 mt-2 lg:text-h2 md:text-h4 text-h5 opacity-85">I love taking Design from vision to reality.</h2>
        </div>
